...
class Tugas extends Model
{
    ...
    protected $fillable = ['nomorsurat', 'mulai', 'akhir', 'menimbang', 'dasar', 'perihal', 'tglpembuatan', 'provinsi_id', 'personel_id', 'pimpinan_id', 'foto']; // mengambil kolom dari table tugas
